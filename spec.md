...
5. **Temporada derivada, nunca hardcodeada**: `CURRENT_SEASON` se deriva de la fecha (15 de julio+ = temporada nueva, ADR-008) en `update.py`; el frontend deriva `CUR_SN` de la última clave de `data.json`. Cero strings de temporada hardcodeados.
